...
class SmartphoneUser {
    ...
    constructor(carica: number, numeroChiamate: number, durataTotale: number,rubrica: Contacts[], bankCount: string) {
        this.carica = carica;
...
class Contacts {
    ...
    private _utenza:string;

    constructor(name:string, imgURL:string, utenza:string) {
        this._name = name;
        this._imgURL = imgURL;
        this._utenza = utenza;
    }
